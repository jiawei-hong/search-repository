    ...
    <div className="container grid grid-cols-[500px_1fr] mx-auto pt-5 repository-list-cotainer h-screen overflow-y-scroll px-5" onScroll={e => scroll(e)}>
      <div className="repository-list-sidebar ml-auto">
        ...
        <div className="card-links mt-3 mb-3">
          <a className="text-decoration-none text-color-default" href={`https://github.com/${params.username}?tab=followers`}>
          ...
          <a className="text-decoration-none text-color-default" href={`https://github.com/${params.username}?tab=following`}>
              ...
              repository.map(repo => (
                <li className="py-5 px-2 first:border-t border-b border-gray-200" key={repo.id}>
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" className="ml-3 mr-1 inline-block fill-gray-500">
...

                    {
                      repo.license && (
                        <>
                          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" className="ml-3 mr-1 fill-gray-500">
