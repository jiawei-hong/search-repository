...
function Repository() {
  ...
  return (
    <React.Fragment>
      <div className="container mx-auto mt-5 p-5 rounded border border-gray-300">
        ...
        <div className="py-5 text-xl text-gray-500">{repository.description}</div>

        <div>
          <div>
            <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" className="mr-2 inline-block">
